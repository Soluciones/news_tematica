...
describe NewsTematica::NewsTematicaDecorator do
  describe "html_con_contadores" do
    ...
    it "debe añadir los contadores de visitas a los enlaces" do
      ...
      link_con_pocos_clics_con_contador = "<a href=\"http://midominio.com/redirections/#{redirection_id_pocos_clics}\" style=\"colorlink\"><span class=\"cuentaclics\">#{pocos_clics}</span>spam</a>"
      link_con_muchos_clics = "<a href=\"http://midominio.com/redirections/#{redirection_id_muchos_clics}\">spam</a>"
      link_con_muchos_clics_con_contador = "<a href=\"http://midominio.com/redirections/#{redirection_id_muchos_clics}\"><span class=\"cuentaclics\">#{muchos_clics}</span>spam</a>"
      html = "blabla #{link_con_pocos_clics} blabla #{link_con_pocos_clics} otro mas #{link_con_muchos_clics}"
      html_con_contador = "blabla #{link_con_pocos_clics_con_contador} blabla #{link_con_pocos_clics_con_contador} otro mas #{link_con_muchos_clics_con_contador}"
