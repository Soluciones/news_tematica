...
ActiveRecord::Schema.define(version: 20150323131307) do
  ...
  add_index "abiertos", ["newsletter_id", "email"], name: "index_abiertos_on_newsletter_id_and_email", unique: true, using: :btree
  add_index "abiertos", ["newsletter_id", "updated_at"], name: "index_abiertos_on_newsletter_id_and_updated_at", using: :btree
  ...
  add_index "adjuntos", ["contenido_id"], name: "index_adjuntos_on_contenido_id", using: :btree
  ...
  add_index "alertas", ["alertable_type", "alertable_id"], name: "index_alertas_on_alertable_type_and_alertable_id", using: :btree
  add_index "alertas", ["usuario_id", "alertable_type", "alertable_id"], name: "ak_alertas_usuario_alerta", unique: true, using: :btree
  ...
  add_index "apuntaos", ["email"], name: "index_apuntaos_on_email", unique: true, using: :btree
  ...
  add_index "asistentes", ["evento_id"], name: "evento_id_2", using: :btree
  ...
  add_index "aux_taggings", ["tag_id", "created_at"], name: "index_aux_taggings_on_tag_id_and_created_at", using: :btree
  add_index "aux_taggings", ["taggable_id", "tag_id"], name: "index_aux_taggings_on_taggable_id_and_tag_id", unique: true, using: :btree
  ...
  add_index "baneoips", ["ip", "created_at"], name: "index_baneoips_on_ip_and_created_at", using: :btree
  ...
  add_index "banner_vigentes", ["banner_id"], name: "banner_id", using: :btree
  add_index "banner_vigentes", ["bloque_id"], name: "bloque_id", using: :btree
  add_index "banner_vigentes", ["seccion"], name: "index_banner_vigentes_on_seccion", using: :btree
  ...
  add_index "banners", ["bloque_id"], name: "bloque_id_1", using: :btree
  ...
  add_index "banners_copy", ["bloque_id"], name: "bloque_id_2", using: :btree
  ...
  add_index "bloques", ["tipo", "orden"], name: "index_bloques_on_tipo_and_orden", using: :btree
  ...
  add_index "busquedas", ["created_at"], name: "index_busquedas_on_created_at", using: :btree
  add_index "busquedas", ["query"], name: "index_busquedas_on_query", using: :btree
  ...
  add_index "candidatos", ["premio_id"], name: "premio_id", using: :btree
  ...
  add_index "captador_estadisticas", ["captador_id", "dominio_de_alta"], name: "index_captador_estadisticas_on_captador_id_and_dominio_de_alta", using: :btree
  ...
  add_index "contenidos", ["ar", "created_at"], name: "index_contenidos_on_ar_and_created_at", using: :btree
  add_index "contenidos", ["cl", "created_at"], name: "index_contenidos_on_cl_and_created_at", using: :btree
  add_index "contenidos", ["co", "created_at"], name: "index_contenidos_on_co_and_created_at", using: :btree
  add_index "contenidos", ["created_at"], name: "index_contenidos_on_created_at", using: :btree
  add_index "contenidos", ["es", "created_at"], name: "index_contenidos_on_es_and_created_at", using: :btree
  add_index "contenidos", ["fecha_titulares"], name: "index_contenidos_on_fecha_titulares", using: :btree
  add_index "contenidos", ["inicial_id", "publicado", "created_at"], name: "index_contenidos_on_inicial_id_and_publicado_and_created_at", using: :btree
  add_index "contenidos", ["mx", "created_at"], name: "index_contenidos_on_mx_and_created_at", using: :btree
  add_index "contenidos", ["opinable_id", "opinable_type"], name: "index_contenidos_on_opinable_id_and_opinable_type", using: :btree
  add_index "contenidos", ["parent_id", "publicado", "created_at"], name: "index_contenidos_on_parent_id_and_publicado_and_created_at", using: :btree
  add_index "contenidos", ["pe", "created_at"], name: "index_contenidos_on_pe_and_created_at", using: :btree
  add_index "contenidos", ["producto_id", "publicado", "created_at"], name: "index_contenidos_on_producto_id_and_publicado_and_created_at", using: :btree
  add_index "contenidos", ["subtipo_id", "blog_id", "created_at"], name: "index_contenidos_on_subtipo_id_and_blog_id_and_created_at", using: :btree
  add_index "contenidos", ["subtipo_id", "created_at"], name: "index_contenidos_on_subtipo_id_and_created_at", using: :btree
  add_index "contenidos", ["subtipo_id", "publicado", "created_at"], name: "index_contenidos_on_subtipo_id_and_publicado_and_created_at", using: :btree
  add_index "contenidos", ["tema", "blog_id", "created_at"], name: "index_contenidos_on_tema_and_blog_id_and_created_at", using: :btree
  add_index "contenidos", ["tema", "created_at"], name: "index_contenidos_on_tema_and_created_at", using: :btree
  add_index "contenidos", ["tema", "respuestas_count"], name: "index_contenidos_on_tema_and_respuestas_count", using: :btree
  add_index "contenidos", ["tema", "ultima_respuesta_id"], name: "index_contenidos_on_tema_and_ultima_respuesta_id", using: :btree
  add_index "contenidos", ["tema", "veces_leido"], name: "index_contenidos_on_tema_and_veces_leido", using: :btree
  add_index "contenidos", ["ultima_respuesta_id"], name: "ultima_respuesta_id", using: :btree
  add_index "contenidos", ["usuario_id", "created_at"], name: "index_contenidos_on_usuario_id_and_created_at", using: :btree
  add_index "contenidos", ["usuario_id", "inicial_id"], name: "index_contenidos_on_usuario_id_and_inicial_id", using: :btree
  add_index "contenidos", ["usuario_id", "publicado", "created_at"], name: "index_contenidos_on_usuario_publicado_created_at", using: :btree
  add_index "contenidos", ["usuario_id", "subtipo_id", "publicado", "created_at"], name: "index_contenidos_on_usuario_subtipo_publicado_created_at", using: :btree
  add_index "contenidos", ["usuario_id", "tema", "created_at"], name: "index_contenidos_on_usuario_id_and_tema_and_created_at", using: :btree
  add_index "contenidos", ["usuario_id", "votos_count", "publicado"], name: "index_contenidos_on_usuario_votos_count_publicado", using: :btree
  add_index "contenidos", ["votos_count"], name: "index_contenidos_on_votos_count", using: :btree
  ...
  add_index "correspondencias", ["desde_permalink", "subtipo_id", "hacia_permalink"], name: "claveunica_corresp_desde_subtipo_hacia", unique: true, using: :btree
  add_index "correspondencias", ["hacia_permalink"], name: "index_correspondencias_on_hacia_permalink", using: :btree
  ...
  add_index "datos_feeds", ["producto_id"], name: "index_datos_feeds_on_producto_id", using: :btree
  add_index "datos_feeds", ["subtipo_id", "nombre_dato", "valor_num"], name: "index_datos_feed_on_subtipo_id_and_nombre_dato_and_valor_num", using: :btree
  add_index "datos_feeds", ["subtipo_id", "producto_id", "nombre_dato"], name: "index_datos_feed_on_subtipo_id_and_producto_id_and_nombre_dato", unique: true, using: :btree
  ...
  add_index "depositos", ["entidad_id", "estado"], name: "index_depositos_on_entidad_id_and_estado", using: :btree
  add_index "depositos", ["estado"], name: "index_depositos_on_estado", using: :btree
  ...
  add_index "estadisticas", ["subtipo_id", "contador"], name: "index_estadisticas_on_subtipo_id_and_contador", using: :btree
  add_index "estadisticas", ["subtipo_id", "contador_anual"], name: "index_estadisticas_on_subtipo_id_and_contador_anual", using: :btree
  add_index "estadisticas", ["subtipo_id", "usuario_id"], name: "index_estadisticas_on_subtipo_id_and_usuario_id", using: :btree
  add_index "estadisticas", ["usuario_id", "subtipo_id"], name: "index_estadisticas_on_usuario_id_and_subtipo_id", using: :btree
  ...
  add_index "favoritismos", ["favoritable_type", "favoritable_id"], name: "index_favoritismos_on_favoritable_type_and_favoritable_id", using: :btree
  add_index "favoritismos", ["usuario_id", "favoritable_type", "favoritable_id"], name: "ak_favoritismos_usuario_favorito", using: :btree
  add_index "favoritismos", ["usuario_id", "tipo"], name: "index_favoritismos_on_usuario_id_and_tipo", using: :btree
  ...
  add_index "fotos", ["contenido_id"], name: "index_fotos_on_contenido_id", using: :btree
  add_index "fotos", ["created_at"], name: "index_fotos_on_created_at", using: :btree
  ...
  add_index "fragmentos", ["contenido_id"], name: "index_fragmentos_on_contenido_id", unique: true, using: :btree
  ...
  add_index "frases", ["fecha_ultima_visualizacion"], name: "index_frases_on_fecha_ultima_visualizacion", using: :btree
  ...
  add_index "hipotecas", ["entidad_id", "estado"], name: "index_hipotecas_on_entidad_id_and_estado", using: :btree
  add_index "hipotecas", ["estado"], name: "index_hipotecas_on_estado", using: :btree
  ...
  add_index "images", ["contenido_id", "orden", "id"], name: "index_images_on_contenido_id_and_orden_and_id", using: :btree
  add_index "images", ["parent_id", "thumbnail"], name: "index_images_on_parent_id_and_thumbnail", using: :btree
  add_index "images", ["producto_id", "contenido_id", "orden", "id"], name: "index_images_on_producto_id_and_contenido_id_and_orden_and_id", using: :btree
  add_index "images", ["usuario_id"], name: "usuario_id", using: :btree
  ...
  add_index "leads", ["promocion_id", "created_at"], name: "index_leads_on_promocion_id_and_created_at", using: :btree
  add_index "leads", ["usuario_id"], name: "index_leads_on_usuario_id", using: :btree
  ...
  add_index "lecturas", ["dia", "seccion", "destino_id"], name: "index_lecturas_on_dia_and_seccion_and_destino_id", using: :btree
  add_index "lecturas", ["dia", "subtipo_id", "destino_id"], name: "index_lecturas_on_dia_and_subtipo_id_and_destino_id", using: :btree
  add_index "lecturas", ["seccion", "destino_id", "dia"], name: "index_lecturas_on_seccion_and_destino_id_and_dia", unique: true, using: :btree
  ...
  add_index "likerts", ["producto", "elemento_a_valorar", "nota"], name: "index_likerts_on_producto_and_elemento_a_valorar_and_nota", using: :btree
  ...
  add_index "pagestaticas", ["bloque", "permalink"], name: "URL_UNICA", unique: true, using: :btree
  ...
  add_index "paises", ["position"], name: "index_paises_on_position", using: :btree
  ...
  add_index "permisos", ["subtipo_id"], name: "subtipo_id_3", using: :btree
  add_index "permisos", ["usuario_id"], name: "usuario_id_1", using: :btree
  ...
  add_index "postalcodes", ["codigo"], name: "ix_postalcodes_codigo", using: :btree
  ...
  add_index "precios", ["evento_id"], name: "evento_id_1", using: :btree
  ...
  add_index "productos", ["publicado", "ultima_valoracion"], name: "index_productos_on_publicado_and_ultima_valoracion", using: :btree
  add_index "productos", ["subtipo_id", "publicado", "created_at"], name: "index_productos_on_subtipo_id_and_publicado_and_created_at", using: :btree
  add_index "productos", ["tipo_producto_id"], name: "tipo_producto_id_2", using: :btree
  add_index "productos", ["type", "publicado", "created_at"], name: "index_productos_on_type_and_publicado_and_created_at", using: :btree
  add_index "productos", ["ultima_valoracion", "publicado"], name: "index_productos_on_ultima_valoracion_and_publicado", using: :btree
  add_index "productos", ["usuario_id"], name: "usuario_id_2", using: :btree
  ...
  add_index "provincias", ["pais_id", "position"], name: "index_provincias_on_pais_id_and_position", using: :btree
  add_index "provincias", ["position"], name: "index_provincias_on_position", using: :btree
  ...
  add_index "puntos", ["candidato_id"], name: "candidato_id", using: :btree
  add_index "puntos", ["usuario_id"], name: "usuario_id_3", using: :btree
  ...
  add_index "rbdis", ["dia"], name: "dia", unique: true, using: :btree
  ...
  add_index "redirections", ["news_tematica_id", "url"], name: "index_redirections_on_news_tematica_id_and_url", using: :btree
  ...
  add_index "relacionados", ["contenido_id"], name: "index_relacionados_on_contenido_id", using: :btree
  ...
  add_index "revisados", ["created_at"], name: "index_revisados_on_created_at", using: :btree
  ...
  add_index "sessions", ["cs_ip"], name: "index_sessions_on_cs_ip", using: :btree
  ...
  add_index "simuladores", ["usuario_id"], name: "usuario_id_4", using: :btree
  ...
  add_index "suscripciones", ["suscriptor_id"], name: "index_suscripciones_on_suscriptor_id", using: :btree
  ...
  add_index "taggings", ["tag_id", "created_at"], name: "index_taggings_on_tag_id_and_created_at", using: :btree
  add_index "taggings", ["tag_id", "fecha_titulares"], name: "index_taggings_on_tag_id_and_fecha_titulares", using: :btree
  add_index "taggings", ["tag_id", "tema"], name: "index_taggings_on_tag_id_and_tema", using: :btree
  add_index "taggings", ["tag_id", "ultima_respuesta_id"], name: "index_taggings_on_tag_id_and_ultima_respuesta_id", using: :btree
  ...
  add_index "tags", ["ar", "categoria", "carpeta"], name: "index_tags_on_ar_and_categoria_and_carpeta", using: :btree
  add_index "tags", ["cl", "categoria", "carpeta"], name: "index_tags_on_cl_and_categoria_and_carpeta", using: :btree
  add_index "tags", ["co", "categoria", "carpeta"], name: "index_tags_on_co_and_categoria_and_carpeta", using: :btree
  add_index "tags", ["es", "categoria", "carpeta"], name: "index_tags_on_es_and_categoria_and_carpeta", using: :btree
  add_index "tags", ["mx", "categoria", "carpeta"], name: "index_tags_on_mx_and_categoria_and_carpeta", using: :btree
  add_index "tags", ["name"], name: "index_tags_on_name", unique: true, using: :btree
  add_index "tags", ["pe", "categoria", "carpeta"], name: "index_tags_on_pe_and_categoria_and_carpeta", using: :btree
  add_index "tags", ["permalink"], name: "index_tags_on_permalink", unique: true, using: :btree
  add_index "tags", ["subtipo_id"], name: "subtipo_id_1", using: :btree
  add_index "tags", ["taggings_count"], name: "index_tags_on_taggings_count", using: :btree
  add_index "tags", ["tipo_producto_id"], name: "tipo_producto_id_1", using: :btree
  add_index "tags", ["ultimo_tagging"], name: "index_tags_on_ultimo_tagging", using: :btree
  ...
  add_index "tipo_productos", ["subtipo_id"], name: "subtipo_id_2", using: :btree
  ...
  add_index "titulares", ["created_at"], name: "index_titulares_on_created_at", using: :btree
  add_index "titulares", ["tema_id", "created_at"], name: "index_titulares_on_tema_id_and_created_at", using: :btree

  create_table "tmp", id: false, force: true do |t|
    t.integer "dato_int"
  end

  add_index "tmp", ["dato_int"], name: "index_tmp_on_dato_int", using: :btree
  ...
  add_index "tmp2", ["dato1"], name: "index_tmp2_on_dato1", using: :btree
  ...
  add_index "ultimos", ["contenido_id"], name: "ix_ultimos_on_contenido_id", using: :btree
  add_index "ultimos", ["created_at"], name: "ix_ultimos_on_created_at", using: :btree
  add_index "ultimos", ["id_penultima"], name: "ix_ultimos_on_id_penultima", using: :btree
  add_index "ultimos", ["id_ultima"], name: "ix_ultimos_on_id_ultima", using: :btree
  add_index "ultimos", ["usuario_id", "created_at"], name: "ix_ultimos_on_usuario_id_and_created_at", using: :btree
  add_index "ultimos", ["usuario_id", "tipo_publicacion", "created_at"], name: "ix_ultimos_on_usuario_id_and_tipo_publicacion_and_created_at", using: :btree
  ...
  add_index "usuarios", ["alta_carteras"], name: "index_usuarios_on_alta_carteras", using: :btree
  add_index "usuarios", ["created_at"], name: "index_usuarios_on_created_at", using: :btree
  add_index "usuarios", ["email"], name: "index_usuarios_on_email", unique: true, using: :btree
  add_index "usuarios", ["nick"], name: "index_usuarios_on_nick", unique: true, using: :btree
  add_index "usuarios", ["nick_limpio"], name: "index_usuarios_on_nick_limpio", unique: true, using: :btree
  add_index "usuarios", ["pais_id"], name: "pais_id", using: :btree
  add_index "usuarios", ["posicion_ranking"], name: "index_usuarios_on_posicion_ranking", using: :btree
  add_index "usuarios", ["posicion_ranking_anual"], name: "index_usuarios_on_posicion_ranking_anual", using: :btree
  add_index "usuarios", ["provincia_id"], name: "provincia_id", using: :btree
  add_index "usuarios", ["token_autorizacion"], name: "index_usuarios_on_token_autorizacion", using: :btree
  add_index "usuarios", ["usuario_del_dia", "posicion_ranking"], name: "index_usuarios_on_usuario_del_dia_and_posicion_ranking", using: :btree
  add_index "usuarios", ["veces_votado"], name: "index_usuarios_on_veces_votado", using: :btree
  ...
  add_index "veces_leidos", ["grupo", "contador"], name: "index_veces_leidos_on_grupo_and_contador", using: :btree
  add_index "veces_leidos", ["leido_id", "leido_type"], name: "index_veces_leidos_on_leido_id_and_leido_type", unique: true, using: :btree
  ...
  add_index "visitas", ["created_at"], name: "index_visitas_on_created_at", using: :btree
  add_index "visitas", ["redirection_id"], name: "index_visitas_on_redirection_id", using: :btree
  add_index "visitas", ["redirection_id"], name: "redirection_id", using: :btree
  add_index "visitas", ["usuario_id"], name: "usuario_id_5", using: :btree
  ...
  add_index "votos", ["autor_id", "created_at"], name: "index_votos_on_autor_id_and_created_at", using: :btree
  add_index "votos", ["contenido_id", "usuario_id"], name: "index_votos_on_contenido_id_and_usuario_id", unique: true, using: :btree
  add_index "votos", ["created_at"], name: "index_votos_on_created_at", using: :btree
  add_index "votos", ["post_id"], name: "index_votos_on_post_id", using: :btree
  add_index "votos", ["usuario_id", "created_at"], name: "index_votos_on_usuario_id_and_created_at", using: :btree
